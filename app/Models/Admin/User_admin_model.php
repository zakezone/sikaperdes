...
class User_admin_model extends Model
{
    ...
    public function defaultgetRole($search_value, $order, $length, $start, $filtkabupaten, $filtkecamatan, $filtkeldesa)
    {
        ...
        if ($search_value) {
            ...
            $search = "nama LIKE '%$keyword%' AND role_id != 1 $filter OR kd_login LIKE '%$keyword%' AND role_id != 1 $filter OR opd LIKE '%$keyword%' AND role_id != 1 $filter OR ampuan LIKE '%$keyword%' AND role_id != 1 $filter OR akses LIKE '%$keyword%' AND role_id != 1 $filter OR tk_instansi LIKE '%$keyword%' AND role_id != 1 $filter";
        } else {
            $search = "role_id != 1 $filter";
        }
    ...
    public function recordsFiltered($search_value, $filtkabupaten, $filtkecamatan, $filtkeldesa)
    {
        ...
        if ($search_value) {
            $keyword = $search_value;
            $search = "AND (nama LIKE '%$keyword%' AND role_id != 1 $filter OR kd_login LIKE '%$keyword%' AND role_id != 1 $filter OR opd LIKE '%$keyword%' AND role_id != 1 $filter OR ampuan LIKE '%$keyword%' AND role_id != 1 $filter OR akses LIKE '%$keyword%' AND role_id != 1 $filter OR tk_instansi LIKE '%$keyword%' AND role_id != 1 $filter)";
        } else {
            $search = "AND role_id != '1' $filter";
        }
