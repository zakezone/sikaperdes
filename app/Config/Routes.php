...
$routes->delete('/user/menu-admin/delete_data_kawasan/(:any)/(:any)', 'User\Menu_admin::deletedatakawasan/$1/$2', ['filter' => 'authusersie']);
$routes->get('/user/menu-admin/input_data_kawasan', 'User\Menu_admin::inputdatakawasan', ['filter' => 'authusersie']);
$routes->match(['get', 'post'], '/user/menu-admin/verifikasi_review/(:any)/(:any)', 'User\Menu_admin::verifikasireview/$1/$2', ['filter' => 'authusersie']);
$routes->match(['get', 'post'], '/user/menu-admin/revisi_review/(:any)/(:any)', 'User\Menu_admin::revisireview/$1/$2', ['filter' => 'authusersie']);
