...
<div class="page-content" id="content">
    <div class="container-fluid">
        ...
        <form class="needs-validation" novalidate action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <?php if ($jenis_klasifikasi['jenis_klasifikasi'] != '') : ?>
                        <div class="form-group row">
                            <label for="jenis_klasifikasi" class="col-sm-2 col-form-label">Nama Klasifikasi</label>
                            <div class="col-sm-6 mb-3">
                                <input type="text" class="form-control" id="jenis_klasifikasi" name="jenis_klasifikasi" value="<?= $jenis_klasifikasi['jenis_klasifikasi']; ?>" readonly>
                            ...
                            <div class="col-sm-4">
                                <button type="editjenisklasifikasi" class="btn btn-info" id="editjenisklasifikasi" data-jenis_klasifikasi="" data-id="<?= $jenis_klasifikasi['id']; ?>"><i class="fas fa-edit"></i></button>
                            </div>
                        </div>
                    <?php else : ?>
                        <div class="form-group row">
