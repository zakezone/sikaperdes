                ...
                <form class="needs-validation" novalidate action="" method="post" enctype="multipart/form-data">
                    ...
                    <?php if ($user['email'] != '') : ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <button type="editemail" class="btn btn-info" id="editemailpemdes" data-email="" data-userid="<?= $user['user_id']; ?>"><i class="fas fa-edit"></i></button>
                            </div>
                        </div>
                    <?php else : ?>
                        <div class="form-group row">
                    ...
                    <?php if ($user['hp'] != '') : ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <button type="edithp" class="btn btn-info" id="edithppemdes" data-hp="" data-userid="<?= $user['user_id']; ?>"><i class="fas fa-edit"></i></button>
                            </div>
                        </div>
                    <?php else : ?>
                        <div class="form-group row">
