                ...
                <form class="needs-validation" novalidate action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-md-2 mb-2">
                            <label for="tahunfilt" class="form-label font-size-13 text-muted">Tahun</label>
                            <select class="form-select" name="tahunfilt" id="tahunfilt">
                                <option value=""></option>
                                <option value="all">All</option>
                                <?php foreach ($getdatatahun as $gdt) : ?>
                                    <option value="<?= $gdt['tahun_pembentukan']; ?>"><?= $gdt['tahun_pembentukan']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
